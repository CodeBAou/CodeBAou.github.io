    ...
    return(
        <div className="diseñowebwordpress-page">
            ...
            <section className="maxheight">
                ...
                <h4 id="algunos-diseños-wordpress">Algunos diseños wordpress...</h4>
                <div className="row_muestras">
                    ...
                    <MuestraVerticalDwba  alt="Diseño web en wordpress para una agencia de modelos" link="#algunos-diseños-wordpress" src="/image/portafolio/miniatura_web_maite_de_leon.webp" Width="200px"/>
                </div>
            </section>
